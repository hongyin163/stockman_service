...
namespace Quartz.Server
{
	...
	public class Configuration
	{
        ...
        private const string DefaultServiceName = "StockMan.JobServer";
        private const string DefaultServiceDisplayName = "StockMan.JobServer";
        private const string DefaultServiceDescription = "蜗牛股票后台服务";
